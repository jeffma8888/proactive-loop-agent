...
- **Production-grade rigor on a portfolio codebase** — **3,300+ passing tests** (green in CI on Python 3.12 and 3.13), fully type-hinted (ships a PEP 561 `py.typed` marker), 16 context collectors, 15 CLI verbs, deterministic and offline end to end.
