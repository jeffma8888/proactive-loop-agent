...
def test_b10_both_intro_claims_publish_the_corrected_floor() -> None:
    ...
    assert "**4,700+ tests**" in intro, intro[-1500:]
    assert "**4,700+ passing tests**" in intro, intro[-1500:]
    assert "4,300" not in intro, "the stale floor token survives in the intro"
