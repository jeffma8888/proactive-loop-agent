...
def test_b10_both_intro_claims_publish_the_corrected_floor() -> None:
    ...
    assert "**4,900+ tests**" in intro, intro[-1500:]
    assert "**4,900+ passing tests**" in intro, intro[-1500:]
    assert "4,800" not in intro, "the stale floor token survives in the intro"
